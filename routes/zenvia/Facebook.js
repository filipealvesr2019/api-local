...
const Facebook = require("../../models/zenvia/Facebook");
...
router.get('/admin/Facebook/messages/:adminID', async (req, res) => {
  const { adminID } = req.params;

  try {
    // Consultar mensagens no MongoDB com base no adminID
    const messages = await Facebook.find({ adminID });
